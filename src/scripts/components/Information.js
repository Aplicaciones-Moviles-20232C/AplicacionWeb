  ...
  return `<article class="contenedor-information">
    <div class="inf">
        ...
        <div class="contenedor-Rowling">
            ...
            She is also known for her philanthropy and activism on social issues. However, he has also been the subject of controversy at times due to his opinions and comments on social media.
            </h3></p>
        </div>
    </div>
        <div class="subtitulo">
           ...
           <div class="form-group">
               <label for="nombre"><h2>Name:</h2></label>
           ...
           <div class="form-group">
               <label for="nota"><h2>Note:</h2></label>
               <textarea type="text" id="nota" name="nota"style="width: 100%;resize: none;" rows="5"></textarea>
